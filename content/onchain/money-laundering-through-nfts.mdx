...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem'}}>
  <thead>
    <tr style={{borderBottom: '2px solid #ec4899'}}>
      <th style={{padding: '0.75rem', textAlign: 'left'}}>Marketplace</th>
      <th style={{padding: '0.75rem', textAlign: 'left'}}>Total Volume</th>
      <th style={{padding: '0.75rem', textAlign: 'left'}}>Wash Volume %</th>
      <th style={{padding: '0.75rem', textAlign: 'left'}}>Wash Trades %</th>
    </tr>
  </thead>
  <tbody>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>OpenSea</td><td style={{padding: '0.75rem'}}>$123.9M</td><td style={{padding: '0.75rem'}}>4.84%</td><td style={{padding: '0.75rem'}}>9.62%</td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Blur</td><td style={{padding: '0.75rem'}}>$32.5M</td><td style={{padding: '0.75rem'}}>1.54%</td><td style={{padding: '0.75rem'}}>2.44%</td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>CryptoPunks</td><td style={{padding: '0.75rem'}}>$25.8M</td><td style={{padding: '0.75rem'}}>0.94%</td><td style={{padding: '0.75rem'}}>0.89%</td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Magic Eden</td><td style={{padding: '0.75rem'}}>$261K</td><td style={{padding: '0.75rem'}}>6.83%</td><td style={{padding: '0.75rem'}}>6.11%</td></tr>
    <tr><td style={{padding: '0.75rem'}}>Sudoswap</td><td style={{padding: '0.75rem'}}>$310K</td><td style={{padding: '0.75rem'}}>25.61%</td><td style={{padding: '0.75rem'}}>2.88%</td></tr>
  </tbody>
</table>
</div>
...
Literally the same address on both sides of the trade. Trivial to write, trivial to detect — which is why this one only catches the laziest launderers. Most marketplaces (OpenSea's Seaport included) reject self-trades at the contract level, but some platforms don't validate, and launderers know which.
...
### United States — DOJ, FinCEN, and the SEC

The US approach is enforcement-led rather than framework-led. There's no comprehensive NFT regulation, but multiple agencies have made clear they're watching:

- **DOJ** has prosecuted NFT fraud cases: the Frosties rug pull ($1.1M, wire fraud + money laundering conspiracy), the Nathaniel Chastain insider trading case (first NFT insider trading prosecution, 2022), and multiple cases involving NFT-related sanctions evasion.
- **FinCEN** has not issued binding guidance specifically classifying NFT marketplaces as money services businesses (MSBs). In practice, most major NFT platforms (OpenSea, Blur, Magic Eden) are **not** registered as MSBs and don't operate under BSA obligations. FinCEN's 2019 CVC guidance leaves the door open for enforcement where a platform facilitates convertible virtual currency exchange — but to date, that door hasn't been walked through for NFT marketplaces. Treasury's 2022 study flagged the risk; no formal rulemaking has followed.
- **SEC** has signalled that some NFTs may qualify as securities, particularly fractionalised NFTs or those sold with an expectation of profit. The Howey test doesn't care what you call the asset.
- **OFAC** sanctions apply regardless: the Lazarus Group's NFT-related laundering through Tornado Cash resulted in sanctions that affected the entire ecosystem.

### Malta — MFSA and the VFA Framework

Malta's Virtual Financial Assets Act (VFA Act, 2018) was ahead of its time. The **MFSA** (Malta Financial Services Authority) regulates VFA service providers with AML/CFT obligations aligned to FATF standards.

Under the Maltese framework, NFTs fall into a grey area — they're not explicitly classified as VFAs unless they carry rights similar to financial instruments. However, any Maltese-licensed entity facilitating NFT trades or custody is subject to full AML obligations under the Prevention of Money Laundering Act (PMLA).

Malta's **FIAU** (Financial Intelligence Analysis Unit) has issued guidance on virtual asset risks, and compliance teams at Maltese CASPs are expected to monitor for NFT-related typologies — including wash trading, rapid value inflation, and layering through NFT marketplaces.

### The Bottom Line

The regulatory picture is fragmented, but the direction is clear: obligations are expanding, enforcement is accelerating, and the "NFTs aren't regulated" argument has a rapidly shrinking shelf life. If you're at a CASP that processes any NFT-adjacent transactions — even fiat off-ramps from marketplace payouts — your AML obligations are already in play.

---

## Step 6: Know the Red Flags

If you're monitoring NFT-related activity at a CASP, exchange, or payment provider, here's what should trigger enhanced due diligence:

**Transaction red flags:**
- Customer deposits large amounts of crypto, immediately purchases high-value NFTs
- NFT sales generate proceeds significantly above original purchase price within a short timeframe
- Funds from NFT sales are immediately withdrawn to fiat or moved to a different platform
- Multiple NFTs purchased and sold in rapid succession with no collecting interest
- Customer uses multiple wallets to interact with the same collection

**Customer red flags:**
- No apparent interest in the art itself — no social presence, no collector community
- Unable to explain rationale for high-value purchases
- Newly created account with minimal verification history
- Transactions routed through jurisdictions with weak AML frameworks

**On-chain red flags:**
- NFT collections with low holder counts but high reported volume
- Top holders are wallet clusters (check with [Bubblemaps](https://bubblemaps.io))
- Sudden volume spikes on previously dormant collections
- Creator wallets that fund buyer wallets
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Dune Analytics</td><td style={{padding: '0.75rem'}}>Query on-chain data, wash trading dashboards</td><td style={{padding: '0.75rem'}}><a href="https://dune.com/hildobby/nft-wash-trading">dune.com/hildobby</a></td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Etherscan</td><td style={{padding: '0.75rem'}}>Explore wallets, transactions, NFT transfers</td><td style={{padding: '0.75rem'}}><a href="https://etherscan.io">etherscan.io</a></td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Bubblemaps</td><td style={{padding: '0.75rem'}}>Visualise wallet clusters and holder distribution</td><td style={{padding: '0.75rem'}}><a href="https://bubblemaps.io">bubblemaps.io</a></td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Chainalysis Blog</td><td style={{padding: '0.75rem'}}>Annual crypto crime reports with NFT data</td><td style={{padding: '0.75rem'}}><a href="https://blog.chainalysis.com">blog.chainalysis.com</a></td></tr>
    <tr style={{borderBottom: '1px solid #333'}}><td style={{padding: '0.75rem'}}>Elliptic</td><td style={{padding: '0.75rem'}}>NFT financial crime reports</td><td style={{padding: '0.75rem'}}><a href="https://elliptic.co">elliptic.co</a></td></tr>
    <tr><td style={{padding: '0.75rem'}}>FATF Guidance</td><td style={{padding: '0.75rem'}}>Virtual asset regulatory framework</td><td style={{padding: '0.75rem'}}><a href="https://fatf-gafi.org">fatf-gafi.org</a></td></tr>
  </tbody>
</table>
</div>
